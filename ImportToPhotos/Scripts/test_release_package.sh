...
test -f "$PACKAGE_DIR/dmg-root/Doctor ImportToPhotos.command"
test -x "$PACKAGE_DIR/dmg-root/Doctor ImportToPhotos.command"
...
grep -q "Doctor ImportToPhotos.command" "$PACKAGE_DIR/dmg-root/README-先读我.md"
...
test -f "$MOUNT_DIR/Doctor ImportToPhotos.command"
...
grep -q "Doctor ImportToPhotos.command" "$ROOT_DIR/../README.md"
